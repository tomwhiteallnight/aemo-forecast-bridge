...
def fetch_aemo_data(report_type):
    if report_type == "forecast":
        ...
        # Crucial: Use DISPATCHPRICE for historical rolling window data
    ...
    try:
        ...
        # Filter for the pattern, sort by date
        ...
        # Grab the latest, largest report
        ...
        print(f"DEBUG: Successfully collected {len(data)} rows for {report_type}")
        return data
